package com.anggapamb.mynavdrawer
    ...
    fun onItemSelected(title: String) {
        scope.launch {
            ...
            if (snackBarResult == SnackbarResult.ActionPerformed) {
                Toast.makeText(context, R.string.subscribed_info , Toast.LENGTH_SHORT).show()
            } else if (snackBarResult == SnackbarResult.Dismissed) {
                Toast.makeText(context, "Not Subscribe", Toast.LENGTH_SHORT).show()
            }
        }
    }
